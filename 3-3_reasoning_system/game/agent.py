...
class CrimeInferenceAgent:

    def __init__(self):
        self.weapons = ["Marteau", "Poisson", "Corde", "Fusil", "Couteau", "Chandelier", "Hache"]
        self.rooms = ["Salon", "Cuisine", "Bureau", "Garage", "Bibliotheque", "Jardin", "Chambre"]
